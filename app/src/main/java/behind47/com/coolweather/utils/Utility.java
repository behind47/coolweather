...
public class Utility {
    ...
    public static void handleWeatherResponse(Context context, String response) {
        try {
            // translate response into jsonObject
            JSONObject jsonObject = new JSONObject(response);
            JSONObject weatherInfo = jsonObject.getJSONObject("weatherinfo");
            // resolve weather info from jsonObject
    ...
    /**
     * save weather info into SharedPreferences file
     *
     * @param context
     * @param cityName
     * @param weatherCode
    ...
    private static void saveWeatherInfo(Context context, String cityName, String weatherCode,
        ...
        editor.putString("min_temp", temp1);
        editor.putString("max_temp", temp2);
